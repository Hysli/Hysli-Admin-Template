...
export const websiteConfig = Object.freeze({
  title: '',
  logo: logoImage,
  logo_collapsed: logoImage_collapsed,
  logo_blue: logoImage_blue,
  logo_blue_collapsed: logoImage_blue_collapsed,
  loginImage: loginImage,
  loginDesc:
    '让每个开发者都可以用最便捷的方法，使用多种类的 HySLI.AI 应用；让开发者可以更多关注自身业务逻辑，享受 HySLI.AI 带来的技术红利'
})
