<template>
	<div class="table-toolbar" v-if="showTableToolBar">
		...
		<div class="flex items-center table-toolbar-right" v-if="showRightToolBar">
			<!--顶部右侧区域-->
...
import { basicProps } from './propsCustom'
...
export default defineComponent({
	...
	setup(props, { emit }) {
		...
		const state = reactive({
			...
			showRightToolBar: unref(getProps as any).showRightToolBar,
			showTableToolBar: unref(getProps as any).showTableToolBar
		})
		...
		const showRightToolBar = computed(() => {
			let rightToolBar = unref(getProps as any).showRightToolBar
			// console.log('rightToolBar', rightToolBar)
			return rightToolBar
		})

		// 控制表格工具栏显示
		const showTableToolBar = computed(() => {
			let tableToolBar = unref(getProps as any).showTableToolBar
			// console.log('tableToolBar', tableToolBar)
			return tableToolBar
		})
